...
import com.xdev.rapidclipse.demo.webservices.dal.CustomerDAO;
...
public class GETServices {
	...
	public Response getCustomerByCustomerID(@PathParam("customerid") final String customerID) throws InterruptedException, ExecutionException {

		final Future<CustomerTransferable> customerCall = Application.getExecutorService().submit(() -> {
